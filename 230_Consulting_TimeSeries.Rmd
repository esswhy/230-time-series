...
```
From these plots, it seems that peak particulate matter lead is around -0.1346. The peak temperatures (mean centered) is -0.192 which again suggests that temperature _leads_ cardiovascular mortality. (Note that in using the `ccf` function, $x$ is the covariate time series and $y$ is the time series of interest. The plots should be symmetric, but the lags/leads will be reversed.)
